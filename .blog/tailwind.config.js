            ...
            typography: ({ theme }) => ({
                blog: {
                    css: {
                        ...
                        // 内联代码风格控制
                        'code:not(pre code)': {
                            backgroundColor: theme('colors.gray.300'),      // 浅灰背景（浅色主题）
                            padding: '0.1em 0.25em !important',             // 强制缩小内边距
                            borderRadius: '0.25rem',
                            fontWeight: '600',
                            fontSize: '0.8em !important',                   // 强制缩小字体
                        },
                        '.dark code:not(pre code)': {
                            backgroundColor: theme('colors.gray.600'),      // 深灰背景（深色主题）
                        },
                        'code:not(pre code)::before': { content: 'none' },  // 去掉内联代码语法标记
                        'code:not(pre code)::after': { content: 'none' },   // 去掉内联代码语法标记
                    },
                },
                DEFAULT: {
                    css: {
